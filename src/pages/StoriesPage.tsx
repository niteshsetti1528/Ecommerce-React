import { StoriesComponent, SubStories } from "../components/StoriesComponent";
const StoriesPage = () => {
  return (
    <div className="w-full bg-white mt-10 py-6 shadow ">
      <StoriesComponent title="Flipkart: The One-stop Shopping Destination">
        <SubStories>
      ...
      <StoriesComponent title="Flipkart Plus">
        <SubStories>
      ...
      <StoriesComponent title="No Cost EMI">
        <SubStories>
      ...
      <StoriesComponent title="EMI On Debit Cards">
        <SubStories>
          In an attempt to make high-end products accessible to all, our No Cost
          EMI plan enables you to shop with us under EMI, without shelling out
          any processing fee. Applicable on select mobiles, laptops, large and
      ...
      <StoriesComponent title="Mobile Exchange Offers">
        <SubStories>
      ...
      <StoriesComponent title="What Can You Buy From Fipkart">
        {""}
      </StoriesComponent>

      <StoriesComponent title="Mobile Phones">
        <SubStories>
      ...
      <StoriesComponent title="Electronic Devices and Accessories">
        <SubStories>
      ...
      <StoriesComponent title="Large Appliances">
        <SubStories>
        ...
        <SubStories>
          ...
          to Purchases.oni@flipkart.com.
        </SubStories>
      </StoriesComponent>

      <StoriesComponent title="Small Home Appliances">
        <SubStories>
      ...
      <StoriesComponent title="Lifestyle">
        <SubStories>
      ...
      <StoriesComponent title="Home and Furniture">
        <SubStories>
      ...
      <StoriesComponent title="Baby and Kids">
        <SubStories>
      ...
      <StoriesComponent title="Books, Sports and Games">
        <SubStories>
      ...
      <StoriesComponent title="Grocery/Supermart">
        <SubStories>
